    ...
    static class Mappings
    {
        public static void RegisterMappings(ObjectMapper mapper)
        {
            ...
            mapper.AddMapping<O2GOfferRow, OfferRow>((Action<O2GOfferRow, OfferRow, ObjectMapper>)((from, to, m) =>
            {
                ...
                to.TradingStatus = Converters.GetInstrumentTradingStatus(from.TradingStatus);
                ...
                to.InstrumentType = Converters.GetInstrumentType(from.InstrumentType);
                ...
                to.AskTradable = Converters.GetPriceTradable(from.AskTradable);
                to.IsBidTradableValid = from.isBidTradableValid;
                to.BidTradable = Converters.GetPriceTradable(from.BidTradable);
